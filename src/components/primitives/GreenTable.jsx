                      ...
                      return (
                        <th key={key} {...restHeaderProps}>
                          ...
                          <span>
                            {column.canFilter ? (
                              <input
                                className='col-search-field'
                                value={column.filterValue || ''}
                                onChange={(event) =>
                                  column.setFilter(event.target.value)
                                }
                              />
                            ) : null}
                          </span>
        ...
        <>
          <footer className='mt-2 d-flex justify-content-between'>
            <span>
              ...
              <GreenButton
                text={'Go'}
                clickFunction={() => gotoPage(gotoPageNumber)}
              />
            </span>
            ...
            <div>
              <GreenButton
                ...
                clickFunction={() => gotoPage(0)}
              />
              <GreenButton
                text={'<'}
                isDisabled={!canPreviousPage}
                clickFunction={() => previousPage()}
              />
              <span>
              ...
              <GreenButton
                text={'>>'}
                isDisabled={!canNextPage}
                clickFunction={() => gotoPage(pageCount - 1)}
              />
            </div>
