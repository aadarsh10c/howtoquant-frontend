...
export default function MainArea(){  
    ...
    let content = (
        <>
            ...
            <p className='pt-1'>Before judging, please be mindful that I am only one person. Commercial projects of this type are built by teams of dozens of developers over months and years.</p>
